...
const trivaForm = document.getElementById("trivia-form");
const lowerContainer = document.querySelector(".lower-container");
const playAgainBtn = document.getElementById("play-again-btn");
const resultsContainer = document.getElementById("results-container");
const resultsScore = document.getElementById("results-score");
const resultsQuestions = document.getElementById("results-questions-amount");
...
function countDownTimer(futureTime,setTime,timerLoop){
    ...
    function showResults(){
        triviaQuestion.style.display = "none";
        lowerContainer.style.display ="none";
        trivaForm.style.display = "none";
        resultBtn.style.display = "none";
        playAgainBtn.style.display = "block";
        resultsContainer.style.display ="flex";
        resultsQuestions.textContent = `Amount of questions: ${data.length}`
        resultsScore.textContent = `Correct answers: ${answerCount}`
    }
